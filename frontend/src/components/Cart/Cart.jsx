...
const Cart = () => {
  return (
    <div className="main__cart__hero">
      <b>
        <h1 style={{ fontSize: "2rem", marginBottom: "40px" ,marginLeft: '20px'}}>CART</h1>
      </b>
      <hr />
      <Flex>
        <Box p="4">
      ...
      <Flex>
        <Box p="4">
          ...
          <br />
          <Button style={{backgroundColor: 'rgb(87,226,128)',color:'white',width: '200px',borderRadius:'0px'}}>Order</Button>
        </Box>
      </Flex>
    </div>
  );
